...
@implementation UIImage (HNCompress)
...
+(NSString*)getImageBase64:(UIImage *) image
{
    ...
    UIImage *newimage = [UIImage compressImage:image newWidth:imagewidth];
    NSData *data = [ UIImage zipImageWithImage:newimage];
